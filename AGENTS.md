...
- 100 000 Kc hard cap — aktuálně 89 500 (mandatory 84 500 + important 4 500 + optional 500)
- 5 people: Mamka, Tatka, Zanetka, Kikinka, Deti
- 6/36 done (termín, radnice, deti informovany, svedci, oddavajici, schuzka prstynky)
...
print(f'Tasks: {len(lines)}/36 | Budget: {m+i+o} (cap 100000) | OK' if (m+i+o)<=100000 and len(lines)==36 else 'GAP')
"
```