...
> Status: active — 16. 8. 2026 (33 úkolů, 5 osob, 89 500 Kč, 23 hostů)
...
| Kdo | Role | Poznámka |
|---|---|---|
| **Mamka** | Nevěsta | Hlavní hrdinka dne |
...
## 3. Harmonogram dne (29. srpna 2026)

| Čas | Aktivita |
|---|---|
| 10:45 | Sraz na Nové radnici Ostrava |
| 11:15 | **Obřad** — Nová radnice Ostrava |
| 12:00 | Gratulace, focení před radnicí |
| 12:30 | Přesun do Zlaté koliby (U Miloše) |
| 13:00 | Uvítání hostů, welcome drink |
| 14:00 | Hostina — menu od Miloše |
| 16:00 | První tanec, hry, zábava |
| 19:00 | Krájení dortu 🍰, přípitek |
| 20:00 | Volný konec, úklid
...
| Termín | Úkol | Kdo | Stav |
|---|---|---|---|
| 29. 5. | Termín konfirmace | Mamka | ✅ |
...
## 7. Rozpory — VYŘEŠENY (16. 5. 2026)

| Otázka | Původní rozpor | Finální rozhodnutí |
|---|---|---|
| **Datum** | 20.6. vs 15.6. | **29. 8. 2026** |
| **Rozpočet** | 200 000 vs 111 800 | **MAX 100 000 Kč** |
| **Kdo organizuje** | Myška+Paprček vs Mamka+Taťka+Děti | **Žanetka (hlavní) + Mamka + Taťka** |
| **Místo** | Terasa | **Nová radnice + Zlatá koliba** |
| **Svědci** | Nevyřešeno | **Kikinka + Žanetka** |
...
|---|---|---|
| 14. 5. | App verze opravena: budget 90k→111800, jména sjednocena na Mamka/Taťka/Děti | Shoda s v2_ultimate |
| 14. 5. | v2_ultimate je referenční lokální verze | Uživatel: "ta v2 byla super" |
| 14. 5. | **Oprava:** Nevdává se dcera, bereme se MY (Taťka+Mamka) po 29 letech ❤️ | Zásadní misinterpretace — omluva |
| 16. 5. | **Overhaul:** finální datum 29.8.2026, budget 100k hard cap, Nová radnice + Zlatá koliba | Uživatel potvrdil po návštěvě radnice |
| 16. 5. | Žanetka = hlavní organizátor, Kikinka + Žanetka = svědci | Uživatel potvrdil |
| 16. 5. | Appka: 38 tasků, 100k budget, iPhone optimalizace, state v2 | Clean break od starých dat |
| 16. 5. | **v3.5:** Tasky 38→35, super modern design, hardcoded notes | Mergnuty: guestbook+favory, cesta; odstraněny deštníky |
| 16. 5. | Všechny rozpory vyřešeny, data sjednocena napříč appkou + Brainem | Jedna verze pravdy |
| 21. 5. | **Místo konání upřesněno:** Koliba U Zlatého Jarouše (U Miloše), Karasova 1130/23, 709 00 Ostrava | Mamka + Žanetka potvrdily osobně u Miloše 21.5. |
| 21. 5. | **V2 Architecture:** Git jako databáze — MD soubory v `data/`, appka fetchuje, write přes GitHub API s PINem | Statická appka, žádný backend, git = audit trail |
| 21. 5. | **PIN model:** Dobrovolný, neotravuje. Bez PINu = local-only, s PINem = sync do gitu. Timestamp validace. | Aby nikdo nebyl obtěžován, ale rodina mohla syncovat |
| 21. 5. | **Hotové úkoly mizí** — defaultně skryté, zobrazitelné. Dokončené = nevratné. | Uživatel: "ať neotravují" |
| 21. 5. | **Dual deploy:** `/` produkce, `/v2/` testovací. README odkazy na obě. | Rychlé porovnání na iPhonu |
| 21. 5. | **Nové features:** Seznam hostů, hlasové poznámky, 1-klik reminder, Google Maps navigace, WhatsApp link | Rozšíření nad rámec původního checklistu |
| 21. 5. | **Oprava:** Děti dostaly úkoly zpět (výzdoba, dort, focení — dle jejich PRD role) | Předchozí sync jim úkoly odebral ve prospěch Kikinky/Žanetky |
...
## 9. Místo konání — upřesněno 21. 5. 2026

- **Koliba U Zlatého Jarouše (U Miloše)** — dříve uváděno jako "Zlatá koliba"
- Karasova 1130/23, 709 00 Ostrava-Mariánské Hory a Hulváky
- https://uzlatehojarouse.cz/ | https://uzlatehojarouse.cz/kontakty/
- Google Maps: `https://maps.google.com/?q=Karasova+1130/23,+709+00+Ostrava`
- Potvrzeno osobně: Mamka + Žanetka u Miloše 21. 5. 2026
...
<!-- PRD_STATS_START -->
✅ **11/33 splněno** · 💰 **89 500 / 100 000 Kč naplánováno** (82 650 Kč utraceno) · 🧑 **23 hostů** (17 potvrzeno) · 👥 **5 osob** · 📅 změny do 2026-08-16
<!-- PRD_STATS_END -->
